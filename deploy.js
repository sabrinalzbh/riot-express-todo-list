...
function transferProjectToRemote(failed, successful) {
  return ssh.putDirectory(
    ...
    '/home/ubuntu/riot-express-todo-list-master',
    {
      recursive: true,
      concurrency: 1,
...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf riot-express-todo-list-master && mkdir riot-express-todo-list-master-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'mkdir riot-express-todo-list-master && cp -r riot-express-todo-list-master-temp/* riot-express-todo-list-master/ && rm -rf riot-express-todo-list-master-temp', {
      cwd: '/home/ubuntu'
  });
}
